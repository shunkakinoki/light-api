import { timelineSnapshotQuerySchema } from "@lightdotso/types";
...
const getHandler: NextApiHandler = async (req, res) => {
  const { category, spaceId, cursor } = validator(
    timelineSnapshotQuerySchema,
    req.query,
  );
...
export const spaceId = apiHandler({
  GET: getHandler,
});
